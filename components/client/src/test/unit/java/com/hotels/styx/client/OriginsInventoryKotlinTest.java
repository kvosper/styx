...
public class OriginsInventoryKotlinTest {
    ...
    private OriginsInventoryKotlin inventory;
    ...
    public void setUp() {
        ...
        inventory = new OriginsInventoryKotlin(eventBus, GENERIC_APP, monitor, connectionFactory, hostClientFactory, meterRegistry);
    }
