...
public class RequestStatsCollectorTest {
    ...
    public void maintainsRequestLatencyTimer() {
        ...
        Timer timer = metrics.get("proxy.request.latency").timer();
    ...
    public void maintainsRequestLatencyTimerForMultipleOngoingRequests() {
        ...
        sink.onTerminate(requestId2);
        timer = metrics.get("proxy.request.latency").timer();
    ...
    public void maintainsIncomingRequestRate() {
        ...
        assertThat(counterValue("request.received", Tags.empty()), is(2.0));
    }
    ...
    public void reports200ResponsesAs2xx() {
        sink.onRequest(requestId);
        sink.onComplete(requestId, 200);
        assertThat(counterValue("response", Tags.of("statusClass", "2xx")), is(1.0));
    }
    ...
    public void reports400ResponsesAs4xx() {
        ...
        assertThat(counterValue("response", Tags.of("statusClass", "4xx")), is(1.0));
    }
    ...
    public void reports500Responses() {
        ...
        assertThat(counterValue("response", Tags.of("statusClass", "5xx").and("statusCode", "500")), is(1.0));
    }
    ...
    public void reports504Responses() {
        ...
        assertThat(counterValue("response", Tags.of("statusClass", "5xx").and("statusCode", "504")), is(1.0));
    }
    ...
    public void reportsUnknownServerErrorCodesAs5xx() {
        ...
        assertThat(counterValue("response", Tags.of("statusClass", "5xx").and("statusCode", "566")), is(1.0));
    }
    ...
    public void reportsUnrecognisedHttpSatusCodesLessThan100() {
        ...
        assertThat(counterValue("response", Tags.of("statusClass", "unrecognised")), is(1.0));
    }
...
//    }
    ...
    private double counterValue(String baseName, Tags tags) {
        return Optional.ofNullable(metrics.get("proxy." + baseName)
                .tags(tags)
                .counter())
                .map(Counter::count)
                .orElse(0.0);
    ...
    private double requestOutstandingValue() {
        return Optional.ofNullable(metrics.get("proxy.request.outstanding")
                .gauge())
                .map(Gauge::value)
                .orElse(0.0);
    }
